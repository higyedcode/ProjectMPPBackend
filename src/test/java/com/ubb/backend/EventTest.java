 ...
 public class EventTest {
     ...
     public void testEqualsAndHashCode() {
         Host host1 = new Host(0L,"A","mail","","","",new ArrayList<Event>());
         Event event1 = new Event(0L,"Birthday Party", LocalDate.of(2024, 4, 15), "123 Main Street", host1);
         Host host2 = new Host(0L,"A","mail","","","",new ArrayList<Event>());
     ...
     public void testToString() {
         Host host = new Host(0L,"A","mail","","","",new ArrayList<Event>());
         Event event = new Event(0L,"Birthday Party", LocalDate.of(2024, 4, 15), "123 Main Street", host);
         String expectedToString = "Event(id=0, eventName=Birthday Party, eventDate=2024-04-15, eventLocation=123 Main Street, host=Host(id=0, name=A, email=mail, bio=, organisation=, socialMediaLink=, events=[]))";
