...
public class HostServiceTest {
    ...
    public void testGetHostById() {
        Optional<Host> optionalHost = Optional.of(new Host(0L,"A","mail","","","",new ArrayList<Event>()));
    ...
    public void testUpdateHost() {
        Long hostId = 1L;
        Host newHostData = new Host(0L,"A","mail","","","",new ArrayList<Event>());
        Host existingHost = new Host(0L,"B","mail","","","",new ArrayList<Event>());
